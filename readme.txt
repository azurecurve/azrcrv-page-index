...
### [Version 1.6.5](https://github.com/azurecurve/azrcrv-page-index/releases/tag/v1.6.5)
 * Update plugin header for compatibility with ClasssicPress v2.
 
### [Version 1.6.4](https://github.com/azurecurve/azrcrv-page-index/releases/tag/v1.6.4)
 * Update plugin header and readme for compatibility with ClassicPress Directory v2.
 * Update Update Manager to version 2.5.0.
 
### [Version 1.6.3](https://github.com/azurecurve/azrcrv-page-index/releases/tag/v1.6.3)
 * Update readme file for compatibility with ClassicPress Directory.
 
### [Version 1.6.2](https://github.com/azurecurve/azrcrv-page-index/releases/tag/v1.6.2)
 * Update readme files.
