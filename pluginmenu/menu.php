 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_pi')){
	function azrcrv_create_plugin_menu_pi(){
		azrcrv_create_plugin_menu_table_pi();
		azrcrv_populate_plugin_menu_table_pi();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_pi')){
	function azrcrv_populate_plugin_menu_table_pi(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_pi')){
	function azrcrv_create_plugin_menu_table_pi(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
